...
sys.path.append("/com.docker.devenvironments.code/Medical-Image-Classification/")
from ResNetDir.custom_data_class import DataModule
...
def continious_train():
    ...
    dataset = DataModule(data_dir="/com.docker.devenvironments.code/Medical-Image-Classification/AWS_data", transformer=transform)
